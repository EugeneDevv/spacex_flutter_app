...
Widget sizeOneVerticalSizedBox = const SizedBox(height: 1);
...
Widget size16VerticalSizedBox = const SizedBox(height: 16);
...
Widget size16HorizontalSizedBox = const SizedBox(width: 16);
Widget mediumHorizontalSizedBox = const SizedBox(width: 20);
Widget largeHorizontalSizedBox = const SizedBox(width: 30);
Widget size40HorizontalSizedBox = const SizedBox(width: 40);
